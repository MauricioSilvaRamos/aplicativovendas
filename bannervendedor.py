...
class BannerVendedor(FloatLayout):
    '''
    Classe responsável pelo Banner das vendas do vendedor
    '''


    def __init__(self, **kwargs):
        '''
        Função responsável por receber as informações do vendedor através de requisição no banco de dados
        e adiciona uma imagem, label_id e label_total_vendas no BannerVendedor.
        :param kwargs:
        '''
        super().__init__()
        ...
        link = f'https://aplicativovendas-47f91-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
